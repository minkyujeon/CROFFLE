...
# CUDA_VISIBLE_DEVICES=7 python linear_eval.py --data_dir /home/minkyu/imagenet100/ --log_dir ./logs/ -c configs/simsiam_image100_eval_sgd.yaml --ckpt_dir ./cache_base_imagenet100/  --eval_from ./cache_base_imagenet100/simsiam-imagenet100-experiment-resnet18_200.pth
