...
# CUDA_VISIBLE_DEVICES=4,5,6,7 python main.py --data_dir /home/minkyu/data/imagenet100/ --log_dir ./logs/ -c configs/simsiam_imagenet100.yaml --ckpt_dir ./cache/ --hide_progress
