...
# CUDA_VISIBLE_DEVICES=0,1,2,3 python linear_eval_multgpu.py --data_dir /home/minkyu/imagenet100/ --log_dir ./logs/ -c configs/simsiam_image100_eval_sgd_hardneg.yaml --ckpt_dir ./debiased_imagenet/  --eval_from ./debiased_imagenet/simsiam-imagenet100-experiment-resnet18_200.pth
