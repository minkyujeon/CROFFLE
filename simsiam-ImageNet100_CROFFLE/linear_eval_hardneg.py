...
# CUDA_VISIBLE_DEVICES=0,1,2,3 python linear_eval_hardneg.py --data_dir /home/minkyu/data/imagenet100/ --log_dir ./logs/ -c configs/simsiam_image100_eval_sgd_hardneg.yaml --ckpt_dir ./imagenet100_simsiam_jin --hide_progress --eval_from ./imagenet100_simsiam_jin/simsiam-imagenet100-experiment-resnet50_200.pth
...
def main(gpu, args):
    ...
    for epoch in global_progress:
        ...
        for idx, (images, labels) in enumerate(local_progress):
            ...
            with torch.no_grad():
                _,_,_,_,feature = model(images.to(args.device))
