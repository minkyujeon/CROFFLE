...
# CUDA_VISIBLE_DEVICES=4 python linear_eval_jcl.py --data_dir /home/minkyu/imagenet100/ --log_dir ./logs/ -c configs/simsiam_image100_eval_sgd_jcl_setting.yaml --ckpt_dir ./cache_base_imagenet100 --hide_progress --eval_from ./cache_base_imagenet100/simsiam-imagenet100-experiment-resnet18_200.pth
